...
3. При включённом флаге `NEXT_PUBLIC_SHOW_TAGS` можно выбрать теги для лучшей категоризации. Если теги не загрузились, появится сообщение «Теги не загрузились».
